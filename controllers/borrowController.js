...
export const returnBorrowedBook = catchAsyncErrors(async(req, res, next)=>{
    ...
    res.status(200).json({
        success: true,
        message: fine !== 0 ? `The book has been returned successfully and the total charge including fine is ₹${book.price + fine}` : `The book has been returned successfully and total charge is ₹${book.price}`
    })
})